                            ...
                            <div className="players-text">
                                <span className={`human-count-number ${(!currentTournament && !preloadedLeaderboardData) ? 'loading-blur' : ''}`}>
                                    {currentTournament
                                        ...
                                        : '...'}
                                </span> <span className="humans-playing-highlight">{currentTournament && (currentTournament.total_tournament_players ?? currentTournament.total_players ?? 0) === 1 ? 'Human' : 'Humans'} are playing to win the prize pool</span>
                            </div>
                        </div>
