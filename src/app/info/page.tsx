            ...
            <div className="max-w-4xl mx-auto px-4 py-6">
                ...
                <div className="flex gap-3 mb-6">
                    <button
                        ...
                        className={`flex-1 py-3 px-4 rounded-lg font-semibold transition-all duration-200 ${activeSection === 'faq'
                    ...
                    <button
                        ...
                        className={`flex-1 py-3 px-4 rounded-lg font-semibold transition-all duration-200 ${activeSection === 'terms'
                                ? 'bg-[#00F5FF] bg-opacity-20 text-[#00F5FF] border-2 border-[#00F5FF] border-opacity-50'
                                : 'bg-[#374151] text-[#E5E7EB] border-2 border-transparent hover:border-[#00F5FF] hover:border-opacity-30'
                            }`}
                    >
                    ...
                    <button
                        ...
                        className={`flex-1 py-3 px-4 rounded-lg font-semibold transition-all duration-200 ${activeSection === 'support'
                                ? 'bg-[#00F5FF] bg-opacity-20 text-[#00F5FF] border-2 border-[#00F5FF] border-opacity-50'
                                : 'bg-[#374151] text-[#E5E7EB] border-2 border-transparent hover:border-[#00F5FF] hover:border-opacity-30'
                            }`}
                    >
